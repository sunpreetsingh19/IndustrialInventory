...
public static String username;
	public LoginPageUser() {
		...
		JButton btnForgotUsernamepassword = new JButton("Forgot Username/Password");
		...
		sl_contentPane.putConstraint(SpringLayout.NORTH, btnBack, 0, SpringLayout.NORTH, btnLogin);
		sl_contentPane.putConstraint(SpringLayout.WEST, btnBack, 0, SpringLayout.WEST, label);
